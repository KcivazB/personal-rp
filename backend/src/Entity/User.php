...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: BudgetGoal::class, mappedBy: 'user_id', orphanRemoval: true)]
    ...
    public function removeBudgetGoal(BudgetGoal $budgetGoal): static
    {
        if ($this->budgetGoals->removeElement($budgetGoal)) {
            ...
            if ($budgetGoal->getUserId() === $this) {
                $budgetGoal->setUserId(null);
            }
        }
